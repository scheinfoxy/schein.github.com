$(document).ready(function() {
	...
	$('#intro').barIndicator(optIntro2);
	$('#intro2').barIndicator(optIntro3);
	$('#intro3').barIndicator(optIntro4);
	$('#intro4').barIndicator(optIntro5);
	$('#intro5').barIndicator(optIntro6);
	$('#intro6').barIndicator(optIntro7);
	$('#intro7').barIndicator(optIntro8);
